...
from traffic.drawing import (EuroPP, PlateCarree, Projection, countries,
                             location, rivers)
...
def _widget(traffic: Traffic):
    return TrafficWidget(traffic)


def _onload():
    Traffic.widget = property(_widget)
